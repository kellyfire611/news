                    ...
                    <div class="banner-text">
                        ...
                        <div class="container">
                            ...
                            <div class="text">
                                ...
                                <?php //the_excerpt(); ?>
                                <p>Hàng đầu về chăm sóc sức khỏe Quý ông</p>
...
function spa_and_salon_footer_credit(){
    ...
    $text .= '<span class="by">' . sprintf( esc_html__( '%s', 'spa-and-salon' ), '<a href="'. esc_url( __( 'http://news.aigiupminhkhong.vn', 'spa-and-salon' ) ) .'" target="_blank">'. esc_html__( '133A Trần Hưng Đạo – phường An Phú, quận Ninh Kiều – Tp Cần Thơ. ', 'spa-and-salon' ) .'</a>' );
