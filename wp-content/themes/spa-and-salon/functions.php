 ...
 */
add_shortcode( 'list-posts', 'list_posts_by_category_shortcode' );
add_filter('widget_text', 'do_shortcode');
function list_posts_by_category_shortcode($atts = []) {
	...
	if($query->have_posts()) {
		...
		while ($query->have_posts()) {
			...
			if(get_the_ID() != $post_id) {
				// if($i==1) {
				// 	$o .= '<div class="bai_dau_tien">';
				// 	$o .= '<a href="'.get_the_permalink().'" class="anh_bai_viet">';
				// 	//$o .= get_the_post_thumbnail("thumbnail",array( "title" => get_the_title(),"alt" => get_the_title()));
				// 	$o .= get_the_post_thumbnail(get_the_ID());
				// 	$o .= '</a>';
				// 	$o .= '<a href="'.get_the_permalink().'" class="tieu_de_bai_viet">'.get_the_title().'</a>';
				// 	$o .= '<p class="trich_dan">'.get_the_excerpt().'</p>';
				// 	$o .= '</div>';
				// } else {
					$o .= '<li><a href="'.get_the_permalink().'">'.get_the_title().'</a></li>';
				// }
				$i++;
			} 
		}
